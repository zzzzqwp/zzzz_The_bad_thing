...
#define MOUSE_X_K -0.001//鼠标x移动系数
#define MOUSE_Y_K -0.01//鼠标y移动系数
...
float aacc[1000];
RM_PID yaw_pid;
kzz_pid_t yaw_zz_pid_s(0.9,0.2,0);//yaw
kzz_pid_t yaw_zz_pid_v(1250,0,0);//yaw
RM_UDE_t RM_yaw_UDE(3,13,3000);//yaw
pid_Feedforward_t yaw_Feedforward(0.001);//yaw
